...
<form id="accesspanel" action="{{ route('login') }}" method="post">
  <h1 id="litheader">PERTAMINA EP</h1>
  @csrf
  <div class="inset">
    <p>
      <input type="text" autocomplete="off" name="username" id="email" placeholder="Username">
    </p>
    <p>
...
<form id="accesspanel">
  ...
  <p class="p-container">
    <a href="{{ url($level) }}" style="background: #fb0;
    border: 1px solid rgba(0,0,0,0.4);
    border-radius: .3em;
    ...
    height: 40px;
    padding: 5px 20px;
    width: 100%;" id="go">Anda Sudah Login! Klik Disini</a>
  </p>
</form>
@endif
